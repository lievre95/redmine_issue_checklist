class IssueChecklistsController < ApplicationController
  ...
  def done
    ...
    if @checklist_item.save
      if RedmineIssueChecklist::RedmineIssueChecklist.settings[:save_log] && old_checklist_item.info != @checklist_item.info
      ...
      if (Setting.issue_done_ratio == 'issue_field') && RedmineIssueChecklist::RedmineIssueChecklist.settings[:issue_done_ratio]
